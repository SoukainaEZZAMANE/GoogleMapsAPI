<?php /* Smarty version Smarty-3.1.12, created on 2014-02-20 15:15:18
...
<body>
  ...
  <div class="content container_12">  
      <div class="box grid_12">
        <div class="box-head"><h2 style ="display:inline-block;">Liste des emplois</h2>  <a href="#" class="open_aj" style='margin-left: 800px;' ><img src=img/icons/basic/plus.png ></a><a href="pdf.php?&action=emploi"  style='margin-left:30px;'><img src=img/icons/basic/print.png ></a>
		</div>
...
">    
		    ...
		    <td><a href="#?action=modifier&id=<?php echo $_smarty_tpl->tpl_vars['data']->value['id_e'];?>
...
"  ><IMG SRC=img/nav/delete.png border=0 alt=Supprimer  align=center></a></td> 
			 <td><a href="#" class="open_plus" id="<?php echo $_smarty_tpl->tpl_vars['data']->value['id_e'];?>
...
<div id="dialog" title="Modifier des emplois">
	<!--====================================================================================================-->
	<!-- /////////////////////////////////////////formulaire modifier ///////////////////////////////////////-->
    <!--====================================================================================================-->
	...
	<tr>
			...
			<tr>
			<td><div class="form-row">
            <p class="form-label">Rénumération</p><input placeholder="2000dh à 4000dh" type="text" name="ren_e" class="ren_e" id="ren_e" /><span class="error"></span>
			</div></td>
			<td><div class="form-row">
            <p class="form-label">Niveau</p><input placeholder="Tapez le niveau d'étude souhaité"  type="text" name="niveau_e" class="niveau_e" id="niveau_e" /><span class="error"></span>
			</div></td>
			</tr>
			<tr>
			<td><div class="form-row">
...
<!--====================================================================================================-->
<!-- /////////////////////////////////////////formulaire d'ajout ///////////////////////////////////////-->   <!--====================================================================================================-->
<div id="dialog_aj" title="Ajouter un emplois">
	<!--<input name="nom" id="nom">
	<input name="pnom" id="prenom">
	<input name="naom" id="age">-->
	<form id='form_aj' method="POST" action='' enctype="multipart/form-data">
	<table width="100%" align ="center" class="t" >
	<tr>
		   <td><div class="form-row">
            <p class="form-label">Entreprise </p>
            <div class="form-item"><input type="text" placeholder="Tapez le nom de l'entreprise"  name='entreprise_e' id="entreprise_ea"/><span class="error"></span></div>
           </div></td>
		   
           <td><div class="form-row">
            <p class="form-label">Déscription </p>
            <div class="form-item"></p><textarea  placeholder="Tapez le but de l'emploi" cols="30" rows="3"type="text" name='desc_entr_e' id="desc_entr_ea"/></textarea><span class="error"></span></div>
           </div></td>
		   </tr>
		   <tr>
		    <td><div class="form-row">
            <p class="form-label">Domaine</p><input  placeholder="Tapez le domaine de l'emploi"  type="text" name="secteur_e" class="secteur_ea" id="secteur_ea" /><span class="error"></span>
			</div></td>
			<td>
			 <div class="form-row">
            <p class="form-label">type de contrat</p><input  placeholder="EX: "  type="text" name="type_e" class="type_ea" id="type_ea" /><span class="error"></span>
			</div></td>
			</tr>
			<tr>
           <td><div class="form-row">
            <p class="form-label">Nombre de poste</p>
            <div class="form-item"><input type="text" placeholder="Ex: 5,7"  name='nbr_poste_e' id="nbr_poste_ea"/><span class="error"></span></div>
           </div></td>
		    <td><div class="form-row">
            <p class="form-label">Rénumération</p>
            <div class="form-item"><input  placeholder="2000dh à 4000dh" type="text" name='ren_e' id="ren_ea"/><span class="error"></span></div>
           </div></td>
		   </tr>
		   <tr>
		    <td><p class="form-label">Niveau</p><input  placeholder="Tapez le niveau d'étude souhaité"  type="text" name="niveau_e" class="niveau_e" id="niveau_ea" /><span class="error"></span></td>
           <td><div class="form-row">
            <p class="form-label">Adresse</p>
            <div class="form-item"><textarea  placeholder="Ex:13,rue Y,Fes" cols="30" rows="3"type="text"name='lieu_e' id="lieu_ea"></textarea><span class="error"></span></div>
           </div></td>
		   </tr>
		   <tr>
		   <td>
		    <div class="form-row">
            <p class="form-label">Date de dépôt</p>
            <div class="form-item"><input  placeholder="Cliquez pour ajouter une date"  type="text" name="date_depot_e" class="datepicker" id="date_depot_ea" /><span class="error"></span></div>
           </div></td>
           <td><div class="form-row">
            <p class="form-label">Ville</p>
            <div class="form-item"><input  placeholder="Ex: Agadir"  type="text" name='ville_e' id="ville_ea"/><span class="error"></span></div>
           </div></td>
		   </tr>
		   <tr>
		    <td><div class="form-row">
            <p class="form-label">email</p>
            <div class="form-item"><input  placeholder="Ex: thefinder@site.com"  type="text" name='email_e' id="email_ea"/><span class="error"></span></div>
           </div></td>
		   
		   <td> <div class="form-row">
            <p class="form-label">téléphone</p>
            <div class="form-item"><input  placeholder="Ex: +212666123456"  type="text" name='tel_e' id="tel_ea"/><span class="error"></span></div>
           </div></td>
		   </tr>
		   <tr>
		   <td> <div class="form-row">
            <p class="form-label">Site</p>
            <div class="form-item"><input placeholder="Ex: +212666123456"  type="text" name='site_e' id="site_ea"/><span class="error"></span></div>
           </div></td>
		   </tr>
		   	  <tr>
				<td>
