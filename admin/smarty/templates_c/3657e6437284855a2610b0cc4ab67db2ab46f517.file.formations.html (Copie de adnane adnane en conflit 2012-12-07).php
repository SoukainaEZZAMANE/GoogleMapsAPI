<?php /* Smarty version Smarty-3.1.12, created on 2012-12-05 15:42:37
...
<body>
      ...
      <ul id="nav">
        <li id="user-panel">
          ...
          <div id="usr-info">
            ...
            <p><a href="#">Profile</a><a href="logout.php">log out</a></p>
          </div>
        </li>
        <li>
        <ul id="top-nav">
  ...
  <div class="content container_12">  
      <div class="box grid_12">
        <div class="box-head"><h2>Liste des Formations</h2></div>
...
?>
        <tr align="center"> 
            ...
            <td><?php echo $_smarty_tpl->tpl_vars['data']->value['desc_f'];?>
</td>              
            <td><?php echo $_smarty_tpl->tpl_vars['data']->value['secteur_f'];?>
</td>              
            <td><?php echo $_smarty_tpl->tpl_vars['data']->value['organisation_f'];?>
</td>
			<td><?php echo $_smarty_tpl->tpl_vars['data']->value['dure_f'];?>
</td>              
			<td><?php echo $_smarty_tpl->tpl_vars['data']->value['lieu_f'];?>
</td> 
			<td><?php echo $_smarty_tpl->tpl_vars['data']->value['nbr_poste_f'];?>
</td> 
			 <td><a href="?action=supprimer&id=<?php echo $_smarty_tpl->tpl_vars['data']->value['id_f'];?>
" ><IMG SRC=img/nav/delete.png border=0 alt=Supprimer  align=center></a></td>
			 <td><a href="?action=Modifier&id=<?php echo $_smarty_tpl->tpl_vars['data']->value['id_f'];?>
