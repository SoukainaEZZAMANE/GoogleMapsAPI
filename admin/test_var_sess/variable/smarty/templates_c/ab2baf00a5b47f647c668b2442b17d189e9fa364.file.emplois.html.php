<?php /* Smarty version Smarty-3.1.12, created on 2012-12-05 15:41:05
  ...
  <div class="top-bar">
      <ul id="nav">
        ...
        <ul id="top-nav">
         ...
         <li class="nav-item">
           <a href="utilisateur.php"><img src="img/nav/grid.png" alt="" /><p>Utilisateurs</p></a>
           
         </li>
         <li class="nav-item">
           <a href="recruteur.php"><img src="img/nav/flm.png" alt="" /><p>Recruteurs </p></a>
         </li>
         <li class="nav-item">
