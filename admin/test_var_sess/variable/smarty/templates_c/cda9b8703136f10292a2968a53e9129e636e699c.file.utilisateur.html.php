<?php /* Smarty version Smarty-3.1.12, created on 2012-12-05 15:49:45
  ...
  <div class="top-bar">
      <ul id="nav">
        ...
        <ul id="top-nav">
         ...
         <li class="nav-item">
           <a href="message.php"><img src="img/nav/gal.png" alt="" /><p>Messages</p></a>
         </li>
...
?>
        <tr align="center"> 
            ...
            <td><?php echo $_smarty_tpl->tpl_vars['data']->value['age_u'];?>
</td>
...
" ><IMG SRC=img/nav/delete.png border=0 alt=Supprimer  align=center></a></td>
			 <td><a href="?action=Modifier&id=<?php echo $_smarty_tpl->tpl_vars['data']->value['id_u'];?>
