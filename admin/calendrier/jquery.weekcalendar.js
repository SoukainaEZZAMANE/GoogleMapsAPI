...
(function($) {
   ...
   $.widget("ui.weekCalendar", {
      ...
      _replaceChars : {
         ...
         g: function(date) {
            return date.getHours() % 24 || 24;
         },
         G: function(date) {
            return date.getHours();
         },
         h: function(date) {
            return ((date.getHours() % 24 || 24) < 10 ? '0' : '') + (date.getHours() % 24 || 24);
         },
         H: function(date) {
   ...
   $.extend($.ui.weekCalendar, {
      ...
      defaults: {
         ...
         newEventText : "Nouveau evenement",
         timeslotHeight: 20,
         ...
         longMonths : ['Janvier', 'Février', 'Mars', 'Avril', 'Mai', 'Juin', 'Juillet', 'Aout', 'Septembre', 'Octobre', 'Novembre', 'Decembre'],
